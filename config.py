...
OLLAMA_MODEL = "llama3.2"                     # The Ollama model to use (e.g., "llama3.2", "mistral", "phi3")
...
BROWSER_USER_AGENT = 'MinimalAgent/0.3 (Mozilla/5.0; Playwright)' # How the browser identifies itself
